...
public class Reply implements Serializable {
    ...
    private static final long serialVersionUID = -6104259188454871792L;
    //回复信息编号
    private int lr_id;
    //回复人
    ...
    public String toString() {
        return "Reply [lr_id=" + lr_id + ", lr_name=" + lr_name + ", lr_date=" + lr_date + ", lr_content=" + lr_content
                + ", lr_for_name=" + lr_for_name + ", lr_for_words=" + lr_for_words + ", lr_for_reply=" + lr_for_reply
