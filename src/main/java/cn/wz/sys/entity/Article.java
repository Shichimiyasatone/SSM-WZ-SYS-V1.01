 ...
 * 
 * @author Satone
 * @date 2019年2月5日下午6:10:35
 */
public class Article implements Serializable {

    private static final long serialVersionUID = 7161014447769446057L;
    // 文章编号
    private int r_id;
    // 文章作者
    ...
    public String toString() {
        return "Article [r_id=" + r_id + ", r_author=" + r_author + ", r_summary=" + r_summary + ", r_content="
                + r_content + ", r_date=" + r_date + ", r_verify=" + r_verify + ", r_publish=" + r_publish
                + ", r_status=" + r_status + "]";
    }
