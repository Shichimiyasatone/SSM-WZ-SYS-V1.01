        ...
        <form action="<%=basePath%>/" method="post">
            <div class="layui-inline" style="margin-left: -10px;">
                ...
                <div class="layui-input-inline" style="margin-left: 88px;">
                    <input type="text" name="r_date" id="r_date" value="${article.r_date}" class="layui-input" readonly="readonly"/>
                </div>
            </div>
            ...
            <div class="layui-inline" style="margin-left: -10px;padding-left: 0;">
                ...
                <div class="layui-input-inline" style="margin-left: -6px;width: 275px;">
                    <input type="text" name="r_summary" id="r_summary" placeholder="请用简短的文字介绍一下你的文章吧！" class="layui-input" value="${article.r_summary}"/>
                </div>
            </div>
            <br/>
            <br/>
