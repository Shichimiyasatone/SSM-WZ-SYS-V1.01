...
<div class="container" style="width: 90%;">
                ...
                <form class="layui-form form-inline" action="<%=basePath%>/article/findByPage.do" role="form" method="post">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input name="r_author" placeholder="请输入文章作者姓名查询" class="layui-input" type="text">
                        </div>
    ...
    <c:if test="${sessionScope.identity_id ne 4}">
        <div class="layui-inline">
            ...
            <a href="<%=basePath%>/article/doArticleWrite.do"><button type="button" id="addBtn" class="layui-btn layui-btn">添加文章</button></a>
        </div>
    </c:if>
    <br/>
    <br/>
            ...
            <c:forEach items="${requestScope.page.beanList}" var="article">
                <tr>
                    ...
                    <c:if test="${sessionScope.identity_id ne 4}">
                        ...
                        <td>
                            <a href="<%=basePath%>/article/doArticleView.do?r_id=${article.r_id}"><button type="button" class="layui-btn layui-btn-sm">查看</button>
                            <a href="<%=basePath%>/article/doArticleEdit.do?r_id=${article.r_id}"><button type="button" class="layui-btn layui-btn-sm layui-btn-normal">编辑</button></a>
    ...
    function clean(r_id){
        layer.open({
            ...
            btn1: function(index,layero){
                $.ajax({
                    url: '<%=basePath%>/article/doDeleteAritcle.do',
                    type: 'POST',
                    data: {r_id: r_id},
