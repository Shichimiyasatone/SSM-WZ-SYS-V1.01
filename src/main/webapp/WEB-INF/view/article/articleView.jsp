...
<div class="container" style="width:80%;">
    ...
    <div style="border-left: 3px solid #f44336;">
        ...
        <div>
            ...
            <span style="font-size:16px;">本项目所有解释权归<strong>Satone</strong>所有</span>
        </div>
        <br/>
    </div>
    <br/>
    ...
    <div style="margin:0 4% 0 4%;">
        <br/>
        <!-- 留言的表单 -->
        <form class="layui-form" action="<%=basePath%>/words/doSaveWords.do" method="post">
                        ...
                        <li style="border-top: 1px dotted #01AAED">
                            ...
                            <div>
                                ...
                                <div class="replycontainer layui-hide" style="margin-left: 61px;">
                                    <form action="<%=basePath%>/reply/doSaveReply.do" method="post" class="layui-form">
...
<script type="text/javascript">
    ...
    <%-- $("#replyBtn").click(function(){
        ...
        $.ajax({
            url: '<%=basePath%>/reply/doSaveReply.do',
            type: 'POST',
            data: [{
