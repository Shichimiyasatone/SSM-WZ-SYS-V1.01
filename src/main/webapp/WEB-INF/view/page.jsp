...
<div class="layui-layout layui-layout-admin">
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    ...
                    <hr/>
                    <dd><a href="<%=basePath%>/admin/doLogOut.do" style="text-decoration: none;;"><strong>退出登录</strong></a></dd>
                </dl>
            </li>
            <li class="layui-nav-item">
            ...
            <li class="layui-nav-item"><a href="<%=basePath%>/admin/doLogOut.do" style="text-decoration: none;;"><strong>退出</strong></a></li>
        </ul>
    </div>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" onclick="javascript: findByPage();" style="text-decoration: none;"><strong>文章列表</strong></a></dd>
                        <dd><a href="javascript:;" onclick="javascript: doArticleWrite();" style="text-decoration: none;"><strong>文章草稿</strong></a></dd>
                        <dd><a href="javascript:;" onclick="javascript: doArticleTrash();" style="text-decoration: none;"><strong>回收站</strong></a></dd>
                    </dl>
                </li>
    ...
    <div class="layui-footer">
        <!-- 底部固定区域 -->
        <strong>© 后台管理系统&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;---->&nbsp;Create by Satone</strong>
...
<script type="text/javascript">
    function doArticleWrite() {
        document.getElementById("content").innerHTML = "<object type=\"text/html\" data=\"<%=basePath%>/article/doArticleWrite.do\" width=\"100%\" height=\"100%\"></object>";
    }
    function findByPage() {
    ...
    function doArticleTrash() {
        document.getElementById("content").innerHTML = "<object type=\"text/html\" data=\"<%=basePath%>/article/doArticleTrash.do\" width=\"100%\" height=\"100%\"></object>";
    }
</script>
</html>