...
<head>
    ...
    <style type="text/css">
        .header{
            background-image: url("<%=basePath%>/static/img/color.png");
            background-size: 100%;
            height: 310px;
        }
        #code{
...
<div class="header">
    <div style="margin: 0 45% 0 45%;padding-top:5%;text-align:center;">
        <div style="height:16%;width:90%;background:black;text-align:center;">
            <h3 style="font-family: Menlo;color:white;padding-top:5%;"><strong>Satone</strong></h3>
        </div>
        <h4 style="margin-top:16%;margin-left:-10%;">
            ...
            <br/>
            <label><a href="https://github.com/Shichimiyasatone">GitHub</a></label>
            &nbsp;&nbsp;&nbsp;
            <label><a href="https://blog.csdn.net/shichimiyasatone">Blog</a></label>
            &nbsp;&nbsp;
            <label><a href="http://www.satone.cn">Resume</a></label>
        </h4>
    </div>
</div>
...
<div class="container">
    <div id="content">
        ...
        <!-- 注册的表单 -->
        <form action="<%=basePath%>/admin/doRegister.do" id="registerform" method="post" class="layui-form" hidden="hidden" style="text-align: center;margin-right:12%;margin-top:10%;">
            <div>
                <div class="layui-form-item layui-inline" style="width:110%">
                    <label class="layui-form-label" style="margin-left:13%;"><i class="fa fa-user fa-fw"></i></label>
                    <div class="layui-input-inline">
